...
select name, population from country where region = 'Southern Europe' order by population asc limit 5;
...
select country from country where code = 'BRA';
...
-- She's in ________Santa Monica______!
